        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              {/* Keep all existing TabsContent sections... */}
          ...
          {/* AI Agent Sidebar - 33% width */}
          <div className="lg:col-span-1 space-y-6">
            <AgentActivityPanel userId="demo_user" currentCourseId={id} />
            
            {/* AI Learning Notebook */}
            {course?.content?.parsedContent?.notebook && course?.content?.parsedContent?.mindMap && (
              <NotebookPanel 
                notebook={course.content.parsedContent.notebook}
            ...
            <ChatMentor 
              userId="demo_user" 
              currentTopic={course?.title || "Advanced React Patterns"}
              userProgress={{
